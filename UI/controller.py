...
class Controller:
    ...
    def handleGetSetAlbum(self, e):
        ...
        try :
            ...
            self._view.txt_result.controls.append(ft.Text("Soglia inserita non corretta: Inserire un intero"))
            return
        if self._choiceAlbum is None:
            ...
            return
        setAlbum=self._model.getSetAlbum(self._choiceAlbum,dtot)
        self._view.txt_result.controls.append(ft.Text("Set di album ottimo trovato"))
        for elemento in setAlbum:
            self._view.txt_result.controls.append(f"{elemento}")
        self._view.update_page()